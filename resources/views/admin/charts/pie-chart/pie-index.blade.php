...
<div class="card card-custom">
    ...
    <div class="card-body">
        ...
        <div class="col-xl-12">
          <div class="create">
              <a href="{{route('piechart.create')}}">
                  <button type="button" class="btn btn-info btn-sm">Add Pie Chart</button>
            ...
            <tbody>
                ...
                <tr class="table-success">
                    ...
                    <td>
                        ...
                        <a href="{{route('piechart.edit',[$cat->id])}}">
                  ...
                  <div class="modal fade" id="exampleModal{{$cat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{route('piechart.destroy')}}" method="POST">@csrf
