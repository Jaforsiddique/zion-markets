...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form action="{{route('monthly.update',[$monthlyreturn->id])}}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="year"
                    ...
                    value="{{ $monthlyreturn->year }}" placeholder="year" />
                @if ($errors->has('year'))
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="jan"
                            ...
                            value="{{ $monthlyreturn->jan }}" placeholder="jan" />
                        @if ($errors->has('jan'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="feb"
                            ...
                            value="{{ $monthlyreturn->feb }}" placeholder="feb" />
                        @if ($errors->has('feb'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="mar"
                            ...
                            value="{{ $monthlyreturn->mar }}" placeholder="march" />
                        @if ($errors->has('mar'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="apr"
                            ...
                            value="{{ $monthlyreturn->apr }}" placeholder="april" />
                        @if ($errors->has('apr'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="may"
                            ...
                            value="{{ $monthlyreturn->may }}" placeholder="May" />
                        @if ($errors->has('may'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="jun"
                            ...
                            value="{{ $monthlyreturn->jun }}" placeholder="June" />
                        @if ($errors->has('jun'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="jul"
                            ...
                            value="{{ $monthlyreturn->jul }}" placeholder="July" />
                        @if ($errors->has('jul'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="aug"
                            ...
                            value="{{ $monthlyreturn->aug }}" placeholder="August" />
                        @if ($errors->has('aug'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="sep"
                            ...
                            value="{{ $monthlyreturn->sep }}" placeholder="September" />
                        @if ($errors->has('sep'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="oct"
                            ...
                            value="{{ $monthlyreturn->oct }}" placeholder="October" />
                        @if ($errors->has('oct'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="nov"
                            ...
                            value="{{ $monthlyreturn->nov }}" placeholder="November" />
                        @if ($errors->has('nov'))
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="dec"
                            ...
                            value="{{ $monthlyreturn->dec }}" placeholder="December" />
                        @if ($errors->has('dec'))
                        <span class="invalid-feedback" role="alert">
