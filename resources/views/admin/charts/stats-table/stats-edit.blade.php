...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form action="{{route('stats.update',[$quantumstats->id])}}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="table_head" class="form-control{{ $errors->has('table_head') ? ' is-invalid' : '' }}"
                    value="{{$quantumstats->table_head}}" placeholder="Title" />
            ...
            <div class="form-group">
                ...
                <input type="text" name="table_data" class="form-control{{ $errors->has('table_data') ? ' is-invalid' : '' }}"
                    value="{{$quantumstats->table_data}}" placeholder="Title" />
