...
<div class="card card-custom">
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                @foreach(App\BarChart::all() as $cat)
                <tr class="table-success">
                    ...
                    <td>
                        ...
                        <a href="{{route('barchart.edit',[$cat->id])}}">
                  ...
                  <div class="modal fade" id="exampleModal{{$cat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{route('barchart.destroy')}}" method="POST">@csrf
